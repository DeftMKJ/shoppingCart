...
//            CGSize size = CGSizeMake(view.intrinsicContentSize.width/2, view.intrinsicContentSize.height/2);
            SKTagButton *button = (SKTagButton *)view;
            CGRect titleRec = [button.titleLabel.text boundingRectWithSize:CGSizeMake(MAXFLOAT, 20) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:12]} context:nil];
            size = CGSizeMake(view.intrinsicContentSize.width - titleRec.size.width - 10, view.intrinsicContentSize.height);
            if (previousView) {
...
//                    imageView.frame = CGRectMake(0, 0, size.width, 5);
...
//                    UIImageView *imageView = view.subviews[1];
//                    imageView.frame = CGRectMake(0, 0 + lineSpacing, width, 5);
//                    imageView.center = view.center;
...
//                UIImageView *imageView = view.subviews[1];
//                imageView.frame =CGRectMake(0, 0, width, 5);
//                imageView.center = view.center;
                currentX += width;
            }
